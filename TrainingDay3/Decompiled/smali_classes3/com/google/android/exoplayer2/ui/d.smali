...
.method public static a(Ljava/lang/CharSequence;F)Lcom/google/android/exoplayer2/ui/d$b;
    .locals 8
    ...
    new-instance p0, Lcom/google/android/exoplayer2/ui/d$b;
    ...
    invoke-direct {p0, v1, p1, v0}, Lcom/google/android/exoplayer2/ui/d$b;-><init>(Ljava/lang/String;Ljava/util/Map;Lcom/google/android/exoplayer2/ui/d$a;)V
    ...
    new-instance p1, Lcom/google/android/exoplayer2/ui/d$b;

    invoke-static {p0}, Lcom/google/android/exoplayer2/ui/d;->b(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v1, v0}, Lcom/google/android/exoplayer2/ui/d$b;-><init>(Ljava/lang/String;Ljava/util/Map;Lcom/google/android/exoplayer2/ui/d$a;)V
    ...
    invoke-static {v3, v6}, La4/s0;->C(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lcom/google/android/exoplayer2/ui/d;->c(Landroid/text/Spanned;F)Landroid/util/SparseArray;
    ...
    invoke-static {v3}, Lcom/google/android/exoplayer2/ui/d;->b(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    check-cast v3, Lcom/google/android/exoplayer2/ui/d$d;

    invoke-static {v3}, Lcom/google/android/exoplayer2/ui/d$d;->a(Lcom/google/android/exoplayer2/ui/d$d;)Ljava/util/List;

    move-result-object v6

    invoke-static {}, Lcom/google/android/exoplayer2/ui/d$c;->c()Ljava/util/Comparator;
    ...
    check-cast v7, Lcom/google/android/exoplayer2/ui/d$c;

    iget-object v7, v7, Lcom/google/android/exoplayer2/ui/d$c;->d:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v3}, Lcom/google/android/exoplayer2/ui/d$d;->b(Lcom/google/android/exoplayer2/ui/d$d;)Ljava/util/List;

    move-result-object v6

    invoke-static {}, Lcom/google/android/exoplayer2/ui/d$c;->d()Ljava/util/Comparator;
    ...
    iget-object v6, v6, Lcom/google/android/exoplayer2/ui/d$c;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v2, v0}, Lcom/google/android/exoplayer2/ui/d$b;-><init>(Ljava/lang/String;Ljava/util/Map;Lcom/google/android/exoplayer2/ui/d$a;)V
...
.method private static c(Landroid/text/Spanned;F)Landroid/util/SparseArray;
    ...
    invoke-static {v4, p1}, Lcom/google/android/exoplayer2/ui/d;->e(Ljava/lang/Object;F)Ljava/lang/String;

    move-result-object v8

    invoke-static {v4}, Lcom/google/android/exoplayer2/ui/d;->d(Ljava/lang/Object;)Ljava/lang/String;
    ...
    new-instance v12, Lcom/google/android/exoplayer2/ui/d$c;
    ...
    invoke-direct/range {v5 .. v10}, Lcom/google/android/exoplayer2/ui/d$c;-><init>(IILjava/lang/String;Ljava/lang/String;Lcom/google/android/exoplayer2/ui/d$a;)V

    invoke-static {v0, v11}, Lcom/google/android/exoplayer2/ui/d;->f(Landroid/util/SparseArray;I)Lcom/google/android/exoplayer2/ui/d$d;

    move-result-object v5

    invoke-static {v5}, Lcom/google/android/exoplayer2/ui/d$d;->b(Lcom/google/android/exoplayer2/ui/d$d;)Ljava/util/List;

    move-result-object v5

    invoke-interface {v5, v12}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v0, v4}, Lcom/google/android/exoplayer2/ui/d;->f(Landroid/util/SparseArray;I)Lcom/google/android/exoplayer2/ui/d$d;

    move-result-object v4

    invoke-static {v4}, Lcom/google/android/exoplayer2/ui/d$d;->a(Lcom/google/android/exoplayer2/ui/d$d;)Ljava/util/List;
...
.method private static d(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_6
    instance-of v0, p0, Lq3/c;

    if-eqz v0, :cond_7

    check-cast p0, Lq3/c;

    iget-object p0, p0, Lq3/c;->a:Ljava/lang/String;
...
.method private static e(Ljava/lang/Object;F)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, La4/s0;->C(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_c
    instance-of p1, p0, Lq3/c;

    if-eqz p1, :cond_10

    check-cast p0, Lq3/c;

    iget p0, p0, Lq3/c;->b:I
    ...
    :cond_11
    instance-of p1, p0, Lq3/e;

    if-eqz p1, :cond_12

    check-cast p0, Lq3/e;

    iget p1, p0, Lq3/e;->a:I

    iget v0, p0, Lq3/e;->b:I

    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/ui/d;->h(II)Ljava/lang/String;

    move-result-object p1

    iget p0, p0, Lq3/e;->c:I

    invoke-static {p0}, Lcom/google/android/exoplayer2/ui/d;->g(I)Ljava/lang/String;
...
.method private static f(Landroid/util/SparseArray;I)Lcom/google/android/exoplayer2/ui/d$d;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v0, Lcom/google/android/exoplayer2/ui/d$d;

    if-nez v0, :cond_0

    new-instance v0, Lcom/google/android/exoplayer2/ui/d$d;

    invoke-direct {v0}, Lcom/google/android/exoplayer2/ui/d$d;-><init>()V
