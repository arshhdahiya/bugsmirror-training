...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/ads/internal/util/zzcg;->b:Ljava/util/Map;

    new-instance v0, Lcom/google/android/gms/ads/internal/util/l;

    invoke-direct {v0, p0}, Lcom/google/android/gms/ads/internal/util/l;-><init>(Lcom/google/android/gms/ads/internal/util/zzcg;)V

    iput-object v0, p0, Lcom/google/android/gms/ads/internal/util/zzcg;->a:Landroid/content/BroadcastReceiver;

    return-void
.end method

.method static bridge synthetic a(Lcom/google/android/gms/ads/internal/util/zzcg;Landroid/content/Context;Landroid/content/Intent;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/ads/internal/util/zzcg;->b(Landroid/content/Context;Landroid/content/Intent;)V

    return-void
.end method

.method private final declared-synchronized b(Landroid/content/Context;Landroid/content/Intent;)V
    .locals 5
    ...
    iget-object v1, p0, Lcom/google/android/gms/ads/internal/util/zzcg;->b:Ljava/util/Map;
...
.method public final declared-synchronized zzb(Landroid/content/Context;)V
    ...
    sget-object p1, Lcom/google/android/gms/internal/ads/qz;->W2:Lcom/google/android/gms/internal/ads/hz;
    ...
    sget-object v0, Lcom/google/android/gms/internal/ads/qz;->E8:Lcom/google/android/gms/internal/ads/hz;
    ...
    iget-object v1, p0, Lcom/google/android/gms/ads/internal/util/zzcg;->a:Landroid/content/BroadcastReceiver;

    const/4 v2, 0x4

    invoke-static {v0, v1, p1, v2}, Ld4/a;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;
...
.method public final declared-synchronized zzc(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    iget-object p1, p0, Lcom/google/android/gms/ads/internal/util/zzcg;->b:Ljava/util/Map;
    ...
    invoke-static {p1, p2, p3, v0}, Ld4/a;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
