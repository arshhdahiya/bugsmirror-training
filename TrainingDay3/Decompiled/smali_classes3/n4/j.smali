...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln4/j;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Ln4/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static b(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Ln4/b;->U1(I)Ljava/lang/String;
...
.method public static e(Landroid/content/Context;)Z
    ...
    invoke-static {v0, v1}, Ln4/k;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Ln4/k;->e(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Ln4/j;->c:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Ln4/j;->c:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Ln4/j;->c:Z

    if-nez p0, :cond_3

    invoke-static {}, Lt4/j;->e()Z
...
.method public static f(Landroid/content/Context;I)I
    ...
    sget v2, Ln4/l;->common_google_play_services_unknown_issue:I
    ...
    sget-object v1, Ln4/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    invoke-static {p0}, Lcom/google/android/gms/common/internal/a1;->a(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lt4/j;->i(Landroid/content/Context;)Z
    ...
    invoke-static {v9, v3}, Ln4/k;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v8, v3}, Ln4/k;->e(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lt4/u;->a(I)I

    move-result p0

    invoke-static {p1}, Lt4/u;->a(I)I
...
.method public static g(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Ln4/j;->k(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static j(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Lt4/s;->b(Landroid/content/Context;ILjava/lang/String;)Z
...
.method static k(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Ln4/j;->h(Landroid/content/Context;)Z
