...
.field private final migrate:Lxe/q;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxe/q<",
...
.field private final sharedPrefs$delegate:Loe/j;

.field private final shouldRunMigration:Lxe/p;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lxe/p<",
            "TT;",
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lxe/p;Lxe/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method public synthetic constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lxe/p;Lxe/q;ILkotlin/jvm/internal/g;)V
    .locals 6
    ...
    invoke-direct {p4, p3}, Landroidx/datastore/migrations/SharedPreferencesMigration$3;-><init>(Lqe/d;)V
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lxe/p;Lxe/q;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lxe/q;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Lxe/p;Lxe/q;ILkotlin/jvm/internal/g;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lxe/q;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public constructor <init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public synthetic constructor <init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;ILkotlin/jvm/internal/g;)V
    .locals 0
    ...
    invoke-direct {p3, p5}, Landroidx/datastore/migrations/SharedPreferencesMigration$2;-><init>(Lqe/d;)V

    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;)V

    return-void
.end method

.method private constructor <init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;Landroid/content/Context;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->shouldRunMigration:Lxe/p;

    iput-object p4, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->migrate:Lxe/q;
    ...
    iput-object p1, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->sharedPrefs$delegate:Loe/j;
    ...
    :cond_0
    invoke-static {p2}, Lkotlin/collections/o;->D0(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method synthetic constructor <init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;Landroid/content/Context;Ljava/lang/String;ILkotlin/jvm/internal/g;)V
    .locals 7
    ...
    invoke-direct {p3, p7}, Landroidx/datastore/migrations/SharedPreferencesMigration$1;-><init>(Lqe/d;)V
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method public constructor <init>(Lxe/a;Ljava/util/Set;Lxe/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Lxe/a;Ljava/util/Set;Lxe/p;Lxe/q;ILkotlin/jvm/internal/g;)V

    return-void
.end method

.method public constructor <init>(Lxe/a;Lxe/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final getSharedPrefs()Landroid/content/SharedPreferences;
    ...
    iget-object v0, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->sharedPrefs$delegate:Loe/j;
...
.method private final getSharedPrefsBackup(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {p1, v1}, Lkotlin/jvm/internal/m;->o(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final getSharedPrefsFile(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p2, v1}, Lkotlin/jvm/internal/m;->o(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
# virtual methods
.method public cleanUp(Lqe/d;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public migrate(Ljava/lang/Object;Lqe/d;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    iget-object v0, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->migrate:Lxe/q;
    ...
    invoke-interface {v0, v1, p1, p2}, Lxe/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public shouldMigrate(Ljava/lang/Object;Lqe/d;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/datastore/migrations/SharedPreferencesMigration$shouldMigrate$1;-><init>(Landroidx/datastore/migrations/SharedPreferencesMigration;Lqe/d;)V
    ...
    iget-object p2, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->shouldRunMigration:Lxe/p;
