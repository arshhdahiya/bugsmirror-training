...
.field private mSettableImageProxyFutureList:Ly6/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ly6/a<",
            "Ljava/util/List<",
...
.field private final mUnderlyingCaptureProcessorCloseFuture:Ly6/a;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
...
.method constructor <init>(Landroidx/camera/core/ProcessingImageReader$Builder;)V
    ...
    iput-object v0, p0, Landroidx/camera/core/ProcessingImageReader;->mSettableImageProxyFutureList:Ly6/a;
    ...
    invoke-interface {v1}, Landroidx/camera/core/impl/CaptureProcessor;->getCloseFuture()Ly6/a;

    move-result-object v0

    iput-object v0, p0, Landroidx/camera/core/ProcessingImageReader;->mUnderlyingCaptureProcessorCloseFuture:Ly6/a;
...
.method private cancelSettableImageProxyBundleFutureList()V
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/camera/core/ProcessingImageReader;->mSettableImageProxyFutureList:Ly6/a;
...
.method closeAndCompleteFutureIfNecessary()V
    ...
    iget-object v0, p0, Landroidx/camera/core/ProcessingImageReader;->mUnderlyingCaptureProcessorCloseFuture:Ly6/a;

    new-instance v1, Landroidx/camera/core/f1;

    invoke-direct {v1, p0, v3}, Landroidx/camera/core/f1;-><init>(Landroidx/camera/core/ProcessingImageReader;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)V
...
.method getCloseFuture()Ly6/a;
    ...
    iget-object v1, p0, Landroidx/camera/core/ProcessingImageReader;->mUnderlyingCaptureProcessorCloseFuture:Ly6/a;

    new-instance v2, Landroidx/camera/core/d1;

    invoke-direct {v2}, Landroidx/camera/core/d1;-><init>()V
    ...
    :cond_0
    iget-object v1, p0, Landroidx/camera/core/ProcessingImageReader;->mCloseFuture:Ly6/a;

    if-nez v1, :cond_1

    new-instance v1, Landroidx/camera/core/e1;

    invoke-direct {v1, p0}, Landroidx/camera/core/e1;-><init>(Landroidx/camera/core/ProcessingImageReader;)V
    ...
    iput-object v1, p0, Landroidx/camera/core/ProcessingImageReader;->mCloseFuture:Ly6/a;
...
.method setupSettableImageProxyBundleCallbacks()V
    ...
    invoke-virtual {v3, v2}, Landroidx/camera/core/SettableImageProxyBundle;->getImageProxy(I)Ly6/a;
    ...
    iput-object v1, p0, Landroidx/camera/core/ProcessingImageReader;->mSettableImageProxyFutureList:Ly6/a;
    ...
    invoke-static {v0, v1, v2}, Landroidx/camera/core/impl/utils/futures/Futures;->addCallback(Ly6/a;Landroidx/camera/core/impl/utils/futures/FutureCallback;Ljava/util/concurrent/Executor;)V
