...
.method public constructor <init>(Landroid/graphics/drawable/Drawable$Callback;Ljava/lang/String;Lf/b;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p3}, Lj/b;->d(Lf/b;)V
...
.method private c(Ljava/lang/String;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p1, p2}, Lf/q;->f(Landroid/graphics/Bitmap;)V
...
.method public a(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lj/b;->d:Ljava/util/Map;
    ...
    :cond_1
    iget-object v2, p0, Lj/b;->c:Lf/b;

    if-eqz v2, :cond_3

    invoke-interface {v2, v0}, Lf/b;->a(Lf/q;)Landroid/graphics/Bitmap;

    move-result-object v0

    if-eqz v0, :cond_2

    invoke-direct {p0, p1, v0}, Lj/b;->c(Ljava/lang/String;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    :try_start_1
    iget-object v4, p0, Lj/b;->b:Ljava/lang/String;
    ...
    iget-object v4, p0, Lj/b;->a:Landroid/content/Context;
    ...
    iget-object v6, p0, Lj/b;->b:Ljava/lang/String;
    ...
    invoke-static {v1, v2, v0}, Lr/j;->l(Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
