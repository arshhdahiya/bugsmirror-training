...
.method private static getValidators(Lcom/google/firebase/perf/v1/p;Landroid/content/Context;)Ljava/util/List;
    .locals 3
    .param p0    # Lcom/google/firebase/perf/v1/p;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            ")",
            "Ljava/util/List<",
            "Lcom/google/firebase/perf/metrics/validator/e;",
            ">;"
        }
    .end annotation
    ...
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->hasTraceMetric()Z
    ...
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->getTraceMetric()Lcom/google/firebase/perf/v1/u;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/google/firebase/perf/metrics/validator/d;-><init>(Lcom/google/firebase/perf/v1/u;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_0
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->hasNetworkRequestMetric()Z
    ...
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->getNetworkRequestMetric()Lcom/google/firebase/perf/v1/n;

    move-result-object v2

    invoke-direct {v1, v2, p1}, Lcom/google/firebase/perf/metrics/validator/c;-><init>(Lcom/google/firebase/perf/v1/n;Landroid/content/Context;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_1
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->hasApplicationInfo()Z
    ...
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->getApplicationInfo()Lcom/google/firebase/perf/v1/e;

    move-result-object v1

    invoke-direct {p1, v1}, Lcom/google/firebase/perf/metrics/validator/a;-><init>(Lcom/google/firebase/perf/v1/e;)V

    invoke-interface {v0, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_2
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->hasGaugeMetric()Z
    ...
    invoke-virtual {p0}, Lcom/google/firebase/perf/v1/p;->getGaugeMetric()Lcom/google/firebase/perf/v1/l;

    move-result-object p0

    invoke-direct {p1, p0}, Lcom/google/firebase/perf/metrics/validator/b;-><init>(Lcom/google/firebase/perf/v1/l;)V
...
.method public static isValid(Lcom/google/firebase/perf/v1/p;Landroid/content/Context;)Z
    .locals 1
    .param p0    # Lcom/google/firebase/perf/v1/p;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {p0, p1}, Lcom/google/firebase/perf/metrics/validator/e;->getValidators(Lcom/google/firebase/perf/v1/p;Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lcom/google/firebase/perf/logging/a;->debug(Ljava/lang/String;)V
    ...
    invoke-virtual {p1}, Lcom/google/firebase/perf/metrics/validator/e;->isValidPerfMetric()Z
