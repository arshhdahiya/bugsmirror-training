...
.method public constructor <init>(Lcom/google/firebase/f;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/installations/local/c;->firebaseApp:Lcom/google/firebase/f;
...
.method private getDataFile()Ljava/io/File;
    ...
    iget-object v0, p0, Lcom/google/firebase/installations/local/c;->dataFile:Ljava/io/File;
    ...
    iget-object v1, p0, Lcom/google/firebase/installations/local/c;->firebaseApp:Lcom/google/firebase/f;
    ...
    iget-object v3, p0, Lcom/google/firebase/installations/local/c;->firebaseApp:Lcom/google/firebase/f;

    invoke-virtual {v3}, Lcom/google/firebase/f;->getPersistenceKey()Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/firebase/installations/local/c;->dataFile:Ljava/io/File;
...
.method private readJSONFromFile()Lorg/json/JSONObject;
    ...
    invoke-direct {p0}, Lcom/google/firebase/installations/local/c;->getDataFile()Ljava/io/File;
...
.method public insertOrUpdatePersistedInstallationEntry(Lcom/google/firebase/installations/local/d;)Lcom/google/firebase/installations/local/d;
    .locals 4
    ...
    invoke-virtual {v3}, Lcom/google/firebase/f;->getApplicationContext()Landroid/content/Context;
...
.method public readPersistedInstallationEntryValue()Lcom/google/firebase/installations/local/d;
    .locals 11
    .annotation build Landroidx/annotation/NonNull;
    .end annotation

    invoke-direct {p0}, Lcom/google/firebase/installations/local/c;->readJSONFromFile()Lorg/json/JSONObject;
    ...
    invoke-virtual {v2, v1}, Lcom/google/firebase/installations/local/d$a;->setFirebaseInstallationId(Ljava/lang/String;)Lcom/google/firebase/installations/local/d$a;
    ...
    invoke-virtual {v1, v2}, Lcom/google/firebase/installations/local/d$a;->setRegistrationStatus(Lcom/google/firebase/installations/local/c$a;)Lcom/google/firebase/installations/local/d$a;

    move-result-object v1

    invoke-virtual {v1, v4}, Lcom/google/firebase/installations/local/d$a;->setAuthToken(Ljava/lang/String;)Lcom/google/firebase/installations/local/d$a;

    move-result-object v1

    invoke-virtual {v1, v5}, Lcom/google/firebase/installations/local/d$a;->setRefreshToken(Ljava/lang/String;)Lcom/google/firebase/installations/local/d$a;

    move-result-object v1

    invoke-virtual {v1, v9, v10}, Lcom/google/firebase/installations/local/d$a;->setTokenCreationEpochInSecs(J)Lcom/google/firebase/installations/local/d$a;

    move-result-object v1

    invoke-virtual {v1, v6, v7}, Lcom/google/firebase/installations/local/d$a;->setExpiresInSecs(J)Lcom/google/firebase/installations/local/d$a;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/google/firebase/installations/local/d$a;->setFisError(Ljava/lang/String;)Lcom/google/firebase/installations/local/d$a;
