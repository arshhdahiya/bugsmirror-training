...
.method private createFetchRequestBody(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/Long;)Lorg/json/JSONObject;
    ...
    invoke-direct {p1, p2}, Lcom/google/firebase/remoteconfig/l;-><init>(Ljava/lang/String;)V

    throw p1
.end method

.method private static extractConfigs(Lorg/json/JSONObject;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/e;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/google/firebase/remoteconfig/l;
    ...
    invoke-virtual {v0, p1}, Lcom/google/firebase/remoteconfig/internal/e$b;->withFetchTime(Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/e$b;
    ...
    :try_start_2
    invoke-virtual {p1, v1}, Lcom/google/firebase/remoteconfig/internal/e$b;->replaceConfigsWith(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/e$b;
    ...
    :try_start_4
    invoke-virtual {p1, v1}, Lcom/google/firebase/remoteconfig/internal/e$b;->withAbtExperiments(Lorg/json/JSONArray;)Lcom/google/firebase/remoteconfig/internal/e$b;
    ...
    :try_start_6
    invoke-virtual {p1, v0}, Lcom/google/firebase/remoteconfig/internal/e$b;->withPersonalizationMetadata(Lorg/json/JSONObject;)Lcom/google/firebase/remoteconfig/internal/e$b;
    ...
    invoke-direct {p1, v0, p0}, Lcom/google/firebase/remoteconfig/l;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method createHttpURLConnection()Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v1, v0}, Lcom/google/firebase/remoteconfig/m;-><init>(Ljava/lang/String;)V

    throw v1
.end method

.method fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/lang/Long;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/j$a;
    .locals 0
    ...
    invoke-static {p8}, Lcom/google/firebase/remoteconfig/internal/j$a;->forBackendHasNoUpdates(Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/j$a;
    ...
    :cond_0
    invoke-static {p3, p8}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;->extractConfigs(Lorg/json/JSONObject;Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/e;

    move-result-object p1

    invoke-static {p1, p2}, Lcom/google/firebase/remoteconfig/internal/j$a;->forBackendUpdatesFetched(Lcom/google/firebase/remoteconfig/internal/e;Ljava/lang/String;)Lcom/google/firebase/remoteconfig/internal/j$a;
    ...
    :cond_1
    :try_start_2
    new-instance p3, Lcom/google/firebase/remoteconfig/p;

    invoke-virtual {p1}, Ljava/net/HttpURLConnection;->getResponseMessage()Ljava/lang/String;

    move-result-object p4

    invoke-direct {p3, p2, p4}, Lcom/google/firebase/remoteconfig/p;-><init>(ILjava/lang/String;)V
    ...
    :goto_1
    :try_start_3
    new-instance p3, Lcom/google/firebase/remoteconfig/l;

    const-string p4, "The client had an error while calling the backend!"

    invoke-direct {p3, p4, p2}, Lcom/google/firebase/remoteconfig/l;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
