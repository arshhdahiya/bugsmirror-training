...
.method public constructor <init>(Lk7/b;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/remoteconfig/internal/r;->loggedChoiceIds:Ljava/util/Map;

    iput-object p1, p0, Lcom/google/firebase/remoteconfig/internal/r;->analyticsConnector:Lk7/b;
...
# virtual methods
.method public logArmActive(Ljava/lang/String;Lcom/google/firebase/remoteconfig/internal/e;)V
    .locals 5
    .param p1    # Ljava/lang/String;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .param p2    # Lcom/google/firebase/remoteconfig/internal/e;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param

    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/r;->analyticsConnector:Lk7/b;
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/google/firebase/remoteconfig/internal/e;->getPersonalizationMetadata()Lorg/json/JSONObject;
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/google/firebase/remoteconfig/internal/e;->getConfigs()Lorg/json/JSONObject;
    ...
    :cond_4
    iget-object v3, p0, Lcom/google/firebase/remoteconfig/internal/r;->loggedChoiceIds:Ljava/util/Map;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, Lcom/google/firebase/remoteconfig/internal/r;->loggedChoiceIds:Ljava/util/Map;
    ...
    invoke-interface {v0, p1, p2, v3}, Lcom/google/firebase/analytics/connector/a;->logEvent(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p2, v1, p1}, Lcom/google/firebase/analytics/connector/a;->logEvent(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
