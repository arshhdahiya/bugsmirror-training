...
.method public constructor <init>()V
    ...
    invoke-static {}, Lcom/google/firebase/messaging/n;->newIntentHandleExecutor()Ljava/util/concurrent/ExecutorService;
...
.method public static synthetic a(Lcom/google/firebase/messaging/i;Landroid/content/Intent;Lr5/l;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/messaging/i;->lambda$onStartCommand$1(Landroid/content/Intent;Lr5/l;)V

    return-void
.end method

.method static synthetic access$000(Lcom/google/firebase/messaging/i;Landroid/content/Intent;)Lr5/l;
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/i;->processIntent(Landroid/content/Intent;)Lr5/l;
...
.method public static synthetic b(Lcom/google/firebase/messaging/i;Landroid/content/Intent;Lr5/m;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/messaging/i;->lambda$processIntent$0(Landroid/content/Intent;Lr5/m;)V
...
.method private finishTask(Landroid/content/Intent;)V
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/h1;->completeWakefulIntent(Landroid/content/Intent;)V
...
.method private synthetic lambda$onStartCommand$1(Landroid/content/Intent;Lr5/l;)V
    .locals 0
...
.method private synthetic lambda$processIntent$0(Landroid/content/Intent;Lr5/m;)V
    .locals 1
    ...
    invoke-virtual {p2, v0}, Lr5/m;->c(Ljava/lang/Object;)V
...
.method private processIntent(Landroid/content/Intent;)Lr5/l;
    .locals 3
    ...
    invoke-direct {v2, p0, p1, v0}, Lcom/google/firebase/messaging/f;-><init>(Lcom/google/firebase/messaging/i;Landroid/content/Intent;Lr5/m;)V
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcom/google/firebase/messaging/i;->processIntent(Landroid/content/Intent;)Lr5/l;

    move-result-object p2

    invoke-virtual {p2}, Lr5/l;->r()Z
    ...
    :cond_1
    new-instance p3, Lcom/google/firebase/messaging/g;

    invoke-direct {p3}, Lcom/google/firebase/messaging/g;-><init>()V
    ...
    invoke-virtual {p2, p3, v0}, Lr5/l;->b(Ljava/util/concurrent/Executor;Lr5/f;)Lr5/l;
