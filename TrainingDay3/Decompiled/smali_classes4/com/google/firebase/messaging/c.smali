...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/messaging/c;->requestCodeProvider:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private static createContentIntent(Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    invoke-static {p2, p1, p3}, Lcom/google/firebase/messaging/c;->createTargetIntent(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/messaging/k0;->paramsWithReservedKeysRemoved()Landroid/os/Bundle;

    move-result-object p3

    invoke-virtual {p2, p3}, Landroid/content/Intent;->putExtras(Landroid/os/Bundle;)Landroid/content/Intent;

    invoke-static {p1}, Lcom/google/firebase/messaging/c;->shouldUploadMetrics(Lcom/google/firebase/messaging/k0;)Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p1}, Lcom/google/firebase/messaging/k0;->paramsForAnalyticsIntent()Landroid/os/Bundle;
    ...
    :cond_1
    invoke-static {}, Lcom/google/firebase/messaging/c;->generatePendingIntentRequestCode()I

    move-result p1

    const/high16 p3, 0x40000000    # 2.0f

    invoke-static {p3}, Lcom/google/firebase/messaging/c;->getPendingIntentFlags(I)I
...
.method private static createDeleteIntent(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;)Landroid/app/PendingIntent;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    invoke-static {p2}, Lcom/google/firebase/messaging/c;->shouldUploadMetrics(Lcom/google/firebase/messaging/k0;)Z
    ...
    invoke-virtual {p2}, Lcom/google/firebase/messaging/k0;->paramsForAnalyticsIntent()Landroid/os/Bundle;
    ...
    invoke-static {p0, p1, p2}, Lcom/google/firebase/messaging/c;->createMessagingPendingIntent(Landroid/content/Context;Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
...
.method private static createMessagingPendingIntent(Landroid/content/Context;Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2}, Lcom/google/firebase/messaging/c;->getPendingIntentFlags(I)I
...
.method public static createNotificationInfo(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/c$a;
    .locals 5
    ...
    invoke-virtual {p2, v1, v0, p3}, Lcom/google/firebase/messaging/k0;->getPossiblyLocalizedString(Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p2, p3}, Lcom/google/firebase/messaging/k0;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p3

    invoke-static {v2, v1, v0, p3, p4}, Lcom/google/firebase/messaging/c;->getSmallIcon(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-static {v0, p2, v1}, Lcom/google/firebase/messaging/c;->getSound(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/res/Resources;)Landroid/net/Uri;
    ...
    :cond_2
    invoke-static {p0, p2, v0, v2}, Lcom/google/firebase/messaging/c;->createContentIntent(Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    invoke-static {p0, p1, p2}, Lcom/google/firebase/messaging/c;->createDeleteIntent(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p2, p0}, Lcom/google/firebase/messaging/k0;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    invoke-static {p1, p0, p4}, Lcom/google/firebase/messaging/c;->getColor(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    invoke-virtual {p2, p0}, Lcom/google/firebase/messaging/k0;->getBoolean(Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-virtual {p2}, Lcom/google/firebase/messaging/k0;->getNotificationPriority()Ljava/lang/Integer;
    ...
    :cond_6
    invoke-virtual {p2}, Lcom/google/firebase/messaging/k0;->getVisibility()Ljava/lang/Integer;
    ...
    :cond_7
    invoke-virtual {p2}, Lcom/google/firebase/messaging/k0;->getNotificationCount()Ljava/lang/Integer;
    ...
    invoke-virtual {p2, p0}, Lcom/google/firebase/messaging/k0;->getLong(Ljava/lang/String;)Ljava/lang/Long;
    ...
    :cond_9
    invoke-virtual {p2}, Lcom/google/firebase/messaging/k0;->getVibrateTimings()[J
    ...
    :cond_a
    invoke-virtual {p2}, Lcom/google/firebase/messaging/k0;->getLightSettings()[I
    ...
    :cond_b
    invoke-static {p2}, Lcom/google/firebase/messaging/c;->getConsolidatedDefaults(Lcom/google/firebase/messaging/k0;)I
    ...
    invoke-static {p2}, Lcom/google/firebase/messaging/c;->getTag(Lcom/google/firebase/messaging/k0;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, v3, p1, p3}, Lcom/google/firebase/messaging/c$a;-><init>(Landroidx/core/app/NotificationCompat$Builder;Ljava/lang/String;I)V

    return-object p0
.end method

.method static createNotificationInfo(Landroid/content/Context;Lcom/google/firebase/messaging/k0;)Lcom/google/firebase/messaging/c$a;
    .locals 2
    ...
    invoke-static {v0, v1}, Lcom/google/firebase/messaging/c;->getManifestMetadata(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/os/Bundle;

    move-result-object v0

    invoke-virtual {p1}, Lcom/google/firebase/messaging/k0;->getNotificationChannelId()Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, v1, v0}, Lcom/google/firebase/messaging/c;->getOrCreateChannel(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, p0, p1, v1, v0}, Lcom/google/firebase/messaging/c;->createNotificationInfo(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/k0;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/c$a;
...
.method private static createTargetIntent(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    .locals 2

    const-string v0, "gcm.n.click_action"

    invoke-virtual {p1, v0}, Lcom/google/firebase/messaging/k0;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/google/firebase/messaging/k0;->getLink()Landroid/net/Uri;
...
.method private static generatePendingIntentRequestCode()I
    ...
    sget-object v0, Lcom/google/firebase/messaging/c;->requestCodeProvider:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private static getConsolidatedDefaults(Lcom/google/firebase/messaging/k0;)I
    .locals 2

    const-string v0, "gcm.n.default_sound"

    invoke-virtual {p0, v0}, Lcom/google/firebase/messaging/k0;->getBoolean(Ljava/lang/String;)Z

    move-result v0

    const-string v1, "gcm.n.default_vibrate_timings"

    invoke-virtual {p0, v1}, Lcom/google/firebase/messaging/k0;->getBoolean(Ljava/lang/String;)Z
...
.method public static getOrCreateChannel(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Landroidx/appcompat/widget/t;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;
...
.method private static getSmallIcon(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-static {p1, v0}, Lcom/google/firebase/messaging/c;->isValidIcon(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {p1, p3}, Lcom/google/firebase/messaging/c;->isValidIcon(Landroid/content/res/Resources;I)Z
...
.method private static getSound(Ljava/lang/String;Lcom/google/firebase/messaging/k0;Landroid/content/res/Resources;)Landroid/net/Uri;
    .locals 1

    invoke-virtual {p1}, Lcom/google/firebase/messaging/k0;->getSoundResourceName()Ljava/lang/String;
...
.method private static getTag(Lcom/google/firebase/messaging/k0;)Ljava/lang/String;
    .locals 2

    const-string v0, "gcm.n.tag"

    invoke-virtual {p0, v0}, Lcom/google/firebase/messaging/k0;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method static shouldUploadMetrics(Lcom/google/firebase/messaging/k0;)Z
    .locals 1
    .param p0    # Lcom/google/firebase/messaging/k0;
