...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/HttpUrl$Companion;-><init>(Lkotlin/jvm/internal/g;)V
...
.method public final queryParameter(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Ldf/i;->n(II)Ldf/e;

    move-result-object v0

    const/4 v2, 0x2

    invoke-static {v0, v2}, Ldf/i;->m(Ldf/c;I)Ldf/c;
...
.method public final queryParameterNames()Ljava/util/Set;
    ...
    invoke-static {v1, v2}, Ldf/i;->n(II)Ldf/e;

    move-result-object v1

    const/4 v2, 0x2

    invoke-static {v1, v2}, Ldf/i;->m(Ldf/c;I)Ldf/c;

    move-result-object v1

    invoke-virtual {v1}, Ldf/c;->d()I

    move-result v2

    invoke-virtual {v1}, Ldf/c;->f()I

    move-result v3

    invoke-virtual {v1}, Ldf/c;->g()I
...
.method public final uri()Ljava/net/URI;
    ...
    invoke-direct {v2, v3}, Ljh/j;-><init>(Ljava/lang/String;)V

    const-string v3, ""

    invoke-virtual {v2, v0, v3}, Ljh/j;->d(Ljava/lang/CharSequence;Ljava/lang/String;)Ljava/lang/String;
