...
# virtual methods
.method public final edit(Ljava/io/File;Lokio/j0;Lokio/f;J)Lokhttp3/internal/cache2/Relay;
    .locals 10
    ...
    invoke-direct/range {v1 .. v9}, Lokhttp3/internal/cache2/Relay;-><init>(Ljava/io/RandomAccessFile;Lokio/j0;JLokio/f;JLkotlin/jvm/internal/g;)V

    const-wide/16 p2, 0x0

    invoke-virtual {v0, p2, p3}, Ljava/io/RandomAccessFile;->setLength(J)V

    sget-object v3, Lokhttp3/internal/cache2/Relay;->PREFIX_DIRTY:Lokio/f;
    ...
    invoke-static/range {v2 .. v7}, Lokhttp3/internal/cache2/Relay;->access$writeHeader(Lokhttp3/internal/cache2/Relay;Lokio/f;JJ)V
...
.method public final read(Ljava/io/File;)Lokhttp3/internal/cache2/Relay;
    ...
    invoke-virtual/range {v3 .. v8}, Lokhttp3/internal/cache2/FileOperator;->read(JLokio/c;J)V

    sget-object v1, Lokhttp3/internal/cache2/Relay;->PREFIX_CLEAN:Lokio/f;
    ...
    invoke-virtual {v0, v3, v4}, Lokio/c;->I0(J)Lokio/f;
