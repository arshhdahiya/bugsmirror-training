...
.method public constructor <init>(Lokio/e;Z)V
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lokio/e;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/j0;IIILkotlin/jvm/internal/g;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILokio/e;I)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v0, v1, v2}, Lokio/e;->I0(J)Lokio/f;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lokio/f;)V
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Ldf/i;->n(II)Ldf/e;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Ldf/i;->m(Ldf/c;I)Ldf/c;
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/_UtilCommonKt;->readMedium(Lokio/e;)I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lokio/f;
    ...
    invoke-interface {p1, v1, v2}, Lokio/e;->I0(J)Lokio/f;
