...
.method private final detachTimeout(Lokio/n;)V
    ...
    invoke-virtual {p1}, Lokio/n;->a()Lokio/k0;

    move-result-object v0

    sget-object v1, Lokio/k0;->NONE:Lokio/k0;

    invoke-virtual {p1, v1}, Lokio/n;->b(Lokio/k0;)Lokio/n;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v0, p1, v1}, Ljh/m;->A(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final newChunkedSink()Lokio/h0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokio/j0;
    .locals 2
...
.method private final newFixedLengthSource(J)Lokio/j0;
    .locals 2
...
.method private final newKnownLengthSink()Lokio/h0;
    .locals 2
...
.method private final newUnknownLengthSource()Lokio/j0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/h0;
    .locals 3
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lokio/h0;
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lokio/h0;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lokio/j0;
    .locals 4
    ...
    :goto_0
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lokio/j0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lokio/j0;
    ...
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lokio/j0;
...
.method public readResponseHeaders(Z)Lokhttp3/Response$Builder;
    ...
    invoke-virtual {v2, v3}, Lokhttp3/Response$Builder;->trailers(Lxe/a;)Lokhttp3/Response$Builder;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/_UtilJvmKt;->skipAll(Lokio/j0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokio/d;->W(Ljava/lang/String;)Lokio/d;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lokio/d;->W(Ljava/lang/String;)Lokio/d;
    ...
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/d;
    ...
    invoke-interface {v3, v0}, Lokio/d;->W(Ljava/lang/String;)Lokio/d;
