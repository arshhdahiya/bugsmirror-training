...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/CertificatePinner$Companion;-><init>(Lkotlin/jvm/internal/g;)V
...
.method public synthetic constructor <init>(Ljava/util/Set;Lokhttp3/internal/tls/CertificateChainCleaner;ILkotlin/jvm/internal/g;)V
    .locals 0
...
.method public static final sha1Hash(Ljava/security/cert/X509Certificate;)Lokio/f;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Lokio/f;
...
.method public static final sha256Hash(Ljava/security/cert/X509Certificate;)Lokio/f;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Lokio/f;
...
.method public final check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lxe/a;)V
...
.method public final varargs check(Ljava/lang/String;[Ljava/security/cert/Certificate;)V
    ...
    invoke-static {p2}, Lkotlin/collections/f;->e0([Ljava/lang/Object;)Ljava/util/List;
...
.method public final check$okhttp(Ljava/lang/String;Lxe/a;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v4, v2}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Lokio/f;

    move-result-object v4

    :cond_3
    invoke-virtual {v6}, Lokhttp3/CertificatePinner$Pin;->getHash()Lokio/f;
    ...
    invoke-virtual {v5, v2}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Lokio/f;
...
.method public final findMatchingPins(Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_1
    invoke-static {v1}, Lkotlin/jvm/internal/k0;->c(Ljava/lang/Object;)Ljava/util/List;
