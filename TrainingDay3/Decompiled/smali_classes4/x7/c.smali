...
.method public static b(IIII)Lorg/json/JSONObject;
    ...
    invoke-static {p1, p0}, Lx7/d;->b(Ljava/lang/String;Ljava/lang/Exception;)V

    :goto_0
    return-object v0
.end method

.method private static c(Lorg/json/JSONObject;)Lx7/c$b;
    .locals 2

    sget-object p0, Lx7/c;->a:Landroid/view/WindowManager;
    ...
    sget-object v0, Lx7/c;->a:Landroid/view/WindowManager;
    ...
    invoke-direct {v1, v0, p0}, Lx7/c$b;-><init>(FF)V
...
.method public static d(Landroid/content/Context;)V
    ...
    sput-object p0, Lx7/c;->a:Landroid/view/WindowManager;
...
.method public static i(Lorg/json/JSONObject;Ls7/j;)V
    .locals 1

    invoke-static {p1}, Lx7/c;->l(Ls7/j;)Z
...
.method public static j(Lorg/json/JSONObject;Ly7/b$a;)V
    .locals 3

    invoke-virtual {p1}, Ly7/b$a;->a()Lu7/e;
    ...
    invoke-virtual {p1}, Ly7/b$a;->c()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lu7/e;->d()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lu7/e;->b()Ls7/h;
    ...
    invoke-virtual {v0}, Lu7/e;->a()Ljava/lang/String;
...
.method private static l(Ls7/j;)Z
    .locals 1

    sget-object v0, Lx7/c$a;->a:[I
...
.method public static m(Lorg/json/JSONObject;)V
    ...
    invoke-static {p0}, Lx7/c;->c(Lorg/json/JSONObject;)Lx7/c$b;
...
.method private static o(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_0
    invoke-static {p0, p1}, Lx7/c;->k(Lorg/json/JSONArray;Lorg/json/JSONArray;)Z
    ...
    invoke-static {v3, v4}, Lx7/c;->u(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
...
.method private static s(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    sget-object v0, Lx7/c;->b:[Ljava/lang/String;
...
.method public static u(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
    ...
    :cond_1
    invoke-static {p0, p1}, Lx7/c;->s(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lx7/c;->t(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lx7/c;->r(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lx7/c;->q(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lx7/c;->p(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-static {p0, p1}, Lx7/c;->o(Lorg/json/JSONObject;Lorg/json/JSONObject;)Z
