...
.field private transient reflected:Lef/b;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lkotlin/jvm/internal/c$a;->b()Lkotlin/jvm/internal/c$a;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Lef/b;

    move-result-object v0

    invoke-interface {v0, p1}, Lef/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lef/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lef/b;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lef/b;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Lef/b;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lef/b;

    :cond_0
    return-object v0
.end method

.method protected abstract computeReflected()Lef/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {v0}, Lef/a;->getAnnotations()Ljava/util/List;
...
.method public getOwner()Lef/e;
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/g0;->c(Ljava/lang/Class;)Lef/e;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lef/b;->getParameters()Ljava/util/List;
...
.method protected getReflected()Lef/b;
    .locals 1
...
.method public getReturnType()Lef/o;
    ...
    invoke-interface {v0}, Lef/b;->getReturnType()Lef/o;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lef/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lef/s;
    ...
    invoke-interface {v0}, Lef/b;->getVisibility()Lef/s;
...
.method public isAbstract()Z
    ...
    invoke-interface {v0}, Lef/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {v0}, Lef/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {v0}, Lef/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Lef/b;->isSuspend()Z
