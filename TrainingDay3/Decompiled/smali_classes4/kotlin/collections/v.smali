...
# direct methods
.method public static A(Ljava/util/List;Lxe/l;)Z
    .locals 1
    ...
    invoke-static {p0, p1, v0}, Lkotlin/collections/v;->y(Ljava/util/List;Lxe/l;Z)Z
...
.method public static C(Ljava/lang/Iterable;Lxe/l;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1, v0}, Lkotlin/collections/v;->x(Ljava/lang/Iterable;Lxe/l;Z)Z
...
.method private static final x(Ljava/lang/Iterable;Lxe/l;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final y(Ljava/util/List;Lxe/l;Z)Z
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0}, Lkotlin/jvm/internal/k0;->b(Ljava/lang/Object;)Ljava/lang/Iterable;

    move-result-object p0

    invoke-static {p0, p1, p2}, Lkotlin/collections/v;->x(Ljava/lang/Iterable;Lxe/l;Z)Z
    ...
    invoke-virtual {v0}, Ldf/c;->i()Lkotlin/collections/g0;
...
.method public static final z(Ljava/util/Collection;Ljava/lang/Iterable;)Z
    ...
    invoke-static {p1, p0}, Lkotlin/collections/m;->a(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/Collection;

    move-result-object p1

    invoke-static {p0}, Lkotlin/jvm/internal/k0;->a(Ljava/lang/Object;)Ljava/util/Collection;
