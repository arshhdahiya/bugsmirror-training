...
.field private final f:Lm6/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILm6/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lm6/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    sget-object v1, Ls5/m;->MaterialCalendarItem:[I

    invoke-virtual {p0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v1, Ls5/m;->MaterialCalendarItem_android_insetLeft:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v1

    sget v2, Ls5/m;->MaterialCalendarItem_android_insetTop:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v2

    sget v3, Ls5/m;->MaterialCalendarItem_android_insetRight:I

    invoke-virtual {p1, v3, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v3

    sget v4, Ls5/m;->MaterialCalendarItem_android_insetBottom:I
    ...
    sget v1, Ls5/m;->MaterialCalendarItem_itemFillColor:I

    invoke-static {p0, p1, v1}, Lj6/d;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    sget v1, Ls5/m;->MaterialCalendarItem_itemTextColor:I

    invoke-static {p0, p1, v1}, Lj6/d;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v7

    sget v1, Ls5/m;->MaterialCalendarItem_itemStrokeColor:I

    invoke-static {p0, p1, v1}, Lj6/d;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v8

    sget v1, Ls5/m;->MaterialCalendarItem_itemStrokeWidth:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v9

    sget v1, Ls5/m;->MaterialCalendarItem_itemShapeAppearance:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    sget v2, Ls5/m;->MaterialCalendarItem_itemShapeAppearanceOverlay:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v0

    invoke-static {p0, v1, v0}, Lm6/k;->b(Landroid/content/Context;II)Lm6/k$b;

    move-result-object p0

    invoke-virtual {p0}, Lm6/k$b;->m()Lm6/k;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILm6/k;Landroid/graphics/Rect;)V
...
.method e(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lm6/k;

    invoke-virtual {v0, v2}, Lm6/g;->setShapeAppearanceModel(Lm6/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lm6/k;

    invoke-virtual {v1, v2}, Lm6/g;->setShapeAppearanceModel(Lm6/k;)V
    ...
    :goto_0
    invoke-virtual {v0, p2}, Lm6/g;->Y(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, p2, v2}, Lm6/g;->e0(FLandroid/content/res/ColorStateList;)V
