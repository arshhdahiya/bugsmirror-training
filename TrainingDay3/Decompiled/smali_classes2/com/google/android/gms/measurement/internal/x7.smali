...
.method final k(Ljava/lang/String;)Landroid/util/Pair;
    ...
    invoke-virtual {v4}, Lcom/google/android/gms/measurement/internal/j4;->d()Landroid/content/Context;
...
.method final m(Ljava/lang/String;Lm5/b;)Landroid/util/Pair;
    .locals 1
    .annotation build Landroidx/annotation/WorkerThread;
    .end annotation
    ...
    invoke-virtual {p2, v0}, Lm5/b;->i(Lm5/a;)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p0, p1}, Lcom/google/android/gms/measurement/internal/x7;->k(Ljava/lang/String;)Landroid/util/Pair;
