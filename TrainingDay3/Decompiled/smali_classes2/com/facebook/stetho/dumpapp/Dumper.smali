...
.field private final mParser:Luh/c;
...
.method public constructor <init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/facebook/stetho/dumpapp/Dumper;-><init>(Ljava/lang/Iterable;Luh/c;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Iterable;Luh/c;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Luh/c;
...
.method private doDump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Luh/c;

    iget-object v1, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v1, v1, Lcom/facebook/stetho/dumpapp/GlobalOptions;->options:Luh/l;

    const/4 v2, 0x1

    invoke-interface {v0, v1, p4, v2}, Luh/c;->a(Luh/l;[Ljava/lang/String;Z)Luh/b;

    move-result-object p4

    iget-object v0, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mGlobalOptions:Lcom/facebook/stetho/dumpapp/GlobalOptions;

    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionHelp:Luh/i;

    invoke-virtual {v0}, Luh/i;->i()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p4, v0}, Luh/b;->d(Ljava/lang/String;)Z
    ...
    iget-object v0, v0, Lcom/facebook/stetho/dumpapp/GlobalOptions;->optionListPlugins:Luh/i;
    ...
    :cond_1
    invoke-virtual {p4}, Luh/b;->c()Ljava/util/List;
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/facebook/stetho/dumpapp/Dumper;->dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Luh/b;)V
...
.method private dumpPluginOutput(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Luh/b;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/facebook/stetho/dumpapp/DumpException;
    ...
    iget-object v4, p0, Lcom/facebook/stetho/dumpapp/Dumper;->mParser:Luh/c;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/facebook/stetho/dumpapp/DumperContext;-><init>(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;Luh/c;Ljava/util/List;)V
...
.method private dumpUsage(Ljava/io/PrintStream;)V
    ...
    invoke-virtual/range {v0 .. v5}, Luh/f;->g(Ljava/io/PrintWriter;ILuh/l;II)V
    :try_end_0
...
.method public dump(Ljava/io/InputStream;Ljava/io/PrintStream;Ljava/io/PrintStream;[Ljava/lang/String;)I
    ...
    move-result p1
    :try_end_0
    .catch Luh/m; {:try_start_0 .. :try_end_0} :catch_3
