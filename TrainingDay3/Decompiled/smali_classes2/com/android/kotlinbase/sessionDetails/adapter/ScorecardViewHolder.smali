.class public final Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;
...
.method public constructor <init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V
    ...
    iput p1, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->itemPosition:I
    ...
    iput-object p1, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->rvAdapter:Lcom/android/kotlinbase/scorecard/widgetScorecard/adapter/WidgetScorecardAdapter;
...
.method private final setRecyclerViewScrollListener()V
    ...
    new-instance v1, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder$setRecyclerViewScrollListener$1;

    invoke-direct {v1, p0}, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder$setRecyclerViewScrollListener$1;-><init>(Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;)V

    invoke-virtual {v0, v1}, Landroidx/recyclerview/widget/RecyclerView;->addOnScrollListener(Landroidx/recyclerview/widget/RecyclerView$OnScrollListener;)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->isScrollListenerSet:Z

    return-void
.end method

.method private final setWidgetComponents(Lcom/android/kotlinbase/sessionDetails/api/viewstates/ScoreCardViewState;)V
    .locals 4

    invoke-virtual {p1}, Lcom/android/kotlinbase/sessionDetails/api/viewstates/ScoreCardViewState;->getData()Lcom/android/kotlinbase/home/api/model/Widget;
    ...
    new-instance v2, Lcom/android/kotlinbase/rx/RxEvent$CallSessionDetailScoreCardWidget;

    iget v3, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->itemPosition:I

    invoke-direct {v2, p1, v3, v0, v1}, Lcom/android/kotlinbase/rx/RxEvent$CallSessionDetailScoreCardWidget;-><init>(Ljava/lang/String;IJ)V
...
.method public bind(Lcom/android/kotlinbase/sessionDetails/api/viewstates/SessionDetailVS;ILcom/android/kotlinbase/sessionDetails/BookMarkDownloadCallbacks;)V
    ...
    iput p2, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->itemPosition:I

    instance-of p2, p1, Lcom/android/kotlinbase/sessionDetails/api/viewstates/ScoreCardViewState;
    ...
    iget-object v2, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->rvAdapter:Lcom/android/kotlinbase/scorecard/widgetScorecard/adapter/WidgetScorecardAdapter;
    ...
    :cond_3
    invoke-virtual {p1}, Lcom/android/kotlinbase/sessionDetails/api/viewstates/ScoreCardViewState;->getMatchList()Ljava/util/List;
    ...
    invoke-direct {p0, p1}, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->setWidgetComponents(Lcom/android/kotlinbase/sessionDetails/api/viewstates/ScoreCardViewState;)V
    ...
    iget-object p2, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->rvAdapter:Lcom/android/kotlinbase/scorecard/widgetScorecard/adapter/WidgetScorecardAdapter;
    ...
    iget-boolean p2, p0, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->isScrollListenerSet:Z

    if-nez p2, :cond_7

    invoke-direct {p0}, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->setRecyclerViewScrollListener()V
    ...
    invoke-virtual {p1}, Lcom/android/kotlinbase/sessionDetails/api/viewstates/ScoreCardViewState;->getSelectedPosition()I

    move-result p3

    invoke-direct {p0, p2, p3}, Lcom/android/kotlinbase/sessionDetails/adapter/ScorecardViewHolder;->isValidIndex(Ljava/util/List;I)Z
