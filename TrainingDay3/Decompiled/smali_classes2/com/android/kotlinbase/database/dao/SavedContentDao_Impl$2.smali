.class Lcom/android/kotlinbase/database/dao/SavedContentDao_Impl$2;
...
.method constructor <init>(Lcom/android/kotlinbase/database/dao/SavedContentDao_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/android/kotlinbase/database/dao/SavedContentDao_Impl$2;->this$0:Lcom/android/kotlinbase/database/dao/SavedContentDao_Impl;
...
.method public bridge synthetic bind(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/android/kotlinbase/database/dao/SavedContentDao_Impl$2;->bind(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/android/kotlinbase/database/entity/SavedContent;)V
...
.method public createQuery()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `savedcontent` SET `_id` = ?,`s_id` = ?,`s_type` = ?,`s_title` = ?,`s_shared_link` = ?,`s_short_desc` = ?,`s_comment_count` = ?,`s_photo_count` = ?,`s_small_image` = ?,`s_large_image` = ?,`s_download_url` = ?,`s_file_size` = ?,`s_progress_size` = ?,`s_is_downloaded` = ?,`s_file_path` = ?,`s_updated_time` = ?,`p_anchor_id` = ?,`s_downloaded_pic_count` = ? WHERE `_id` = ?"
