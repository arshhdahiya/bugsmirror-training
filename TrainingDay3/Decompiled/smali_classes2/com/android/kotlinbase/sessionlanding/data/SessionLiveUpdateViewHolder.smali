.class public final Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;
...
.method public static synthetic a(Lcom/android/kotlinbase/sessionlanding/api/viewstates/SessionVS;Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;Landroid/view/View;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;->bind$lambda$0(Lcom/android/kotlinbase/sessionlanding/api/viewstates/SessionVS;Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;Landroid/view/View;)V

    return-void
.end method

.method private static final bind$lambda$0(Lcom/android/kotlinbase/sessionlanding/api/viewstates/SessionVS;Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;Landroid/view/View;)V
    .locals 2
    ...
    check-cast p0, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;

    invoke-virtual {p0}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;->getBlogId()Ljava/lang/String;
...
.method private final setData(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, p2, p3}, Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;->setAdapter(Ljava/util/ArrayList;Ljava/lang/String;)V
...
.method public bind(Lcom/android/kotlinbase/sessionlanding/api/viewstates/SessionVS;ILcom/android/kotlinbase/sessionlanding/BookMarkDownloadCallbacks;)V
    ...
    instance-of p3, p1, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;

    if-eqz p3, :cond_b

    move-object p3, p1

    check-cast p3, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;

    invoke-virtual {p3}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;->getLiveUpdates()Ljava/util/List;
    ...
    invoke-virtual {p3}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;->getBlogContent()Ljava/util/List;
    ...
    invoke-virtual {p3}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;->getTitle()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p3}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/LiveUpdatesVS;->getBlogId()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p0, p2, v0, p3}, Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;->setData(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p2, v0, p3}, Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;->setLiveData(Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)V

    :goto_6
    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->itemView:Landroid/view/View;

    new-instance p3, Lcom/android/kotlinbase/sessionlanding/data/m;

    invoke-direct {p3, p1, p0}, Lcom/android/kotlinbase/sessionlanding/data/m;-><init>(Lcom/android/kotlinbase/sessionlanding/api/viewstates/SessionVS;Lcom/android/kotlinbase/sessionlanding/data/SessionLiveUpdateViewHolder;)V
