.class public final Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;
...
.method public constructor <init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V
    ...
    iput-object p1, p0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->electionWidgetEPAdapter:Lcom/android/kotlinbase/home/adapter/ElectionWidgetEPAdapter;

    const/4 p1, -0x1

    iput p1, p0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->itemPosition:I

    return-void
.end method

.method public static final synthetic access$getElectionWidgetEPAdapter$p(Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;)Lcom/android/kotlinbase/home/adapter/ElectionWidgetEPAdapter;
    .locals 0

    iget-object p0, p0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->electionWidgetEPAdapter:Lcom/android/kotlinbase/home/adapter/ElectionWidgetEPAdapter;

    return-object p0
.end method

.method public static final synthetic access$logStateSelectedEvent(Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->logStateSelectedEvent(Ljava/lang/String;)V
...
.method private final setParentTabValues(Ljava/util/List;Ljava/util/List;I)V
    ...
    iget-object v1, p0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->electionWidgetEPAdapter:Lcom/android/kotlinbase/home/adapter/ElectionWidgetEPAdapter;
    ...
    invoke-direct {p0, p3}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->setRecyclerViewScrollListener(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    invoke-direct {p0, p1, v1}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->isValidIndex(Ljava/util/List;I)Z
    ...
    new-instance v1, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder$setParentTabValues$electionTabAdapter$1;

    invoke-direct {v1, p0, p2, p1, v0}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder$setParentTabValues$electionTabAdapter$1;-><init>(Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;Ljava/util/List;Ljava/util/List;Lcom/android/kotlinbase/home/HomeActivity;)V
    ...
    invoke-direct {p0, p2, p3}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->isValidIndexStateDetail(Ljava/util/List;I)Z

    move-result p3

    if-eqz p3, :cond_3

    iget-object p3, p0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->electionWidgetEPAdapter:Lcom/android/kotlinbase/home/adapter/ElectionWidgetEPAdapter;
...
.method private final setRecyclerViewScrollListener(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder$setRecyclerViewScrollListener$1;

    invoke-direct {v0, p1}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder$setRecyclerViewScrollListener$1;-><init>(Landroidx/recyclerview/widget/RecyclerView;)V
...
.method private final setWidgetComponents(Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;)V
    .locals 7

    invoke-virtual {p1}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;->getData()Lcom/android/kotlinbase/home/api/model/Widget;
    ...
    :goto_2
    invoke-virtual {p1}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;->getStateList()Ljava/util/List;
    ...
    new-instance v5, Lcom/android/kotlinbase/rx/RxEvent$CallEPSessionLandingElectionWidget;

    iget v6, p0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->itemPosition:I

    invoke-direct {v5, v0, v6, v3, v4}, Lcom/android/kotlinbase/rx/RxEvent$CallEPSessionLandingElectionWidget;-><init>(Ljava/lang/String;IJ)V
    ...
    invoke-virtual {p1}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;->getStateDetailsList()Ljava/util/List;
    ...
    invoke-virtual {p1}, Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;->getSelectedAgencyPosition()I

    move-result v4

    invoke-direct {p0, v0, v3, v4}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->setParentTabValues(Ljava/util/List;Ljava/util/List;I)V
...
.method public bind(Lcom/android/kotlinbase/sessionlanding/api/viewstates/SessionVS;ILcom/android/kotlinbase/sessionlanding/BookMarkDownloadCallbacks;)V
    ...
    iput p2, p0, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->itemPosition:I

    instance-of p2, p1, Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;

    if-eqz p2, :cond_0

    check-cast p1, Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;

    invoke-direct {p0, p1}, Lcom/android/kotlinbase/sessionlanding/data/ElectionWidgetEPParentViewHolder;->setWidgetComponents(Lcom/android/kotlinbase/sessionlanding/api/viewstates/ElectionExitPollViewState;)V
